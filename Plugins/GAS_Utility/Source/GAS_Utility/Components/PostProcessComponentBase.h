...
#include "PostProcessComponentBase.generated.h"

/**
 * 
 */
UCLASS(BlueprintType,Blueprintable,ClassGroup = Rendering, collapsecategories, hidecategories = (Object), editinlinenew, meta = (BlueprintSpawnableComponent))
class GAS_UTILITY_API UPostProcessComponentBase : public USceneComponent, public IInterface_PostProcessVolume
{
	...
	void DestroyPostProcessComponent();

	/** Destroys the post process component after a specified delay */
	UFUNCTION(BlueprintCallable, Category="Component")
	void DestroyComponentAfterDelay(float Delay);

	/** Handle for the delayed destruction timer */
