...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GAS_Utility|Attributes")
	UAttributeChanger* CreateAttributeChanger(FGameplayAttribute Attribute, TEnumAsByte<EAttributeChanger::Type> Operation, float Value);
};
