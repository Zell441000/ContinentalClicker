...
public:
	UPROPERTY(BlueprintAssignable,Category="AsyncTask|CooldownChanged")
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"),Category="AsyncTask|CooldownChanged")
	...
	UFUNCTION(BlueprintCallable,Category="AsyncTask|CooldownChanged")
	void EndTask();
